...
2) Чекаємо sweep нижньої/верхньої межі range
3) Чекаємо reclaim всередину range
4) Підтверджуємо BOS / MSS на 1m
5) Підтверджуємо CVD
6) Підтверджуємо volume spike
7) Рахуємо SL/TP і перевіряємо RR
